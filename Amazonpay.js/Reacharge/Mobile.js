        ...
        <View>
            ...
            <View style={{ flex: 1, backgroundColor: "#efefef" }}>
                <Text style={{
                    ...
                    alignSelf: 'center',
                    fontWeight: 'bold'
                }}>MOBILE RECHARGE</Text>

                <View
                    style={{
                        height: 90, width: "95%", marginLeft: 10,
                    ...
                    <View>
                        ...
                        <Image style={{
                            height: 84, width: "176%", resizeMode: "contain", marginTop: -80, flexDirection: "row"
                        }}
                ...
                <View style={{
                    ...
                    alignItems: "center", alignSelf: 'center', borderRadius: 5, marginTop: 20, backgroundColor: "#ffffff",
                }}>

                    <TextInput style={{ height: 80, color: "gray", width: "100%", fontWeight: 'bold', fontSize: 15, }}
                        placeholder="Enter your 10 digit mobile number" placeholderTextColor="gray" />
                </View>
                <View style={{
                    height: 40, width: "95%", borderWidth: 1, borderColor: "#a0a8a9", justifyContent: "center",
                    ...
                    <TextInput style={{ height: 80, color: "gray", width: "100%", fontWeight: 'bold', fontSize: 15, }}
                        placeholder="Operater,Circle" placeholderTextColor="gray" />
                ...
                <View style={{
                    ...
                    <TextInput style={{ height: 80, color: "gray", width: "100%", fontWeight: 'bold', fontSize: 15, }}
                        placeholder="Enter Plan Amount" placeholderTextColor="gray" />
