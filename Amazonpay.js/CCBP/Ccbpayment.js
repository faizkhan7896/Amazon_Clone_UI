            ...
            <View style={{ backgroundColor: "white" }}>
                ...
                <View
                    ...
                    <Text style={{ color: '#000', fontSize: 13, fontWeight: 'bold', marginLeft: 15, marginTop: 7 }}>
                        Get uP TO Rs.300 back
                </Text>
                    <Text style={{ color: '#000', fontSize: 11, marginLeft: 15, }}>
                        On Credit card bill payment of </Text>

                    <Text style={{ color: '#000', fontSize: 11, marginLeft: 15, }}>
                        min.value Rs.5000, using Amazon                </Text>

                    <Text style={{ color: '#000', fontSize: 11, marginLeft: 15, }}>
                        Pay upi before 1st Apr.      </Text>
                ...
                <View style={{
                    ...
                    <TextInput style={{ height: 80, width: "100%", fontWeight: 'bold', fontSize: 15, }}
                ...
                <View style={{
                    ...
                    <TextInput style={{ height: 80, width: "100%", fontWeight: 'bold', fontSize: 15, color: "gray" }}
                        placeholder="Select Banck" placeholderTextColor="gray" />
