            ...
            <View style={[styles.container]}>
                <LinearGradient colors={['#4fe7ea', '#a2e6d1']} >
                    ...
                    >
                        <View style={{ flexDirection: "row", }}>
                            <Image style={{
                                height: 45, width: "35%", resizeMode: "contain", marginLeft: -20, marginTop: 15,
                                borderRadius: 150
                            }}
                                source={require("../Assets/user.png")} />

                            <Text style={styles.Hellow}>Hello, Alfaiz</Text>
                        </View>
                ...
                >
                    <Text style={{
                        marginTop: 30,
                        marginLeft: 30,
                        fontSize: 19, borderBottomWidth: 1, borderColor: "gray"
                    }}>Today's Deals</Text>
                </TouchableOpacity>
                ...
                <Image style={{
                    height: 70, width: "100%", marginTop: 20
                }}
                ...
                >
                    ...
                    <Image style={{
                        height: 20, width: "90%", resizeMode: "contain", marginTop: -20
                    }}
        ...
        >
            <LinearGradient colors={['#4fe7ea', '#a2e6d1']} >
                <View style={{ paddingVertical: 8, }}>
                    <View style={{
                        height: 65, width: "100%", flexDirection: "row", marginTop: 10
                    }}>
                        <TouchableOpacity
                            ...
                            <Image source={require("../Assets/menu.png")}
                                style={{
                                    height: 25, width: 30, marginLeft: 15,
                                }}
                            />
                        </TouchableOpacity>
